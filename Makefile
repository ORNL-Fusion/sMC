...
CFLAGS += $(INCLUDEFLAGS)
CPPFLAGS += $(INCLUDEFLAGS) -DDEBUGLEVEL=$(DEBUG) -DPITCH_SCATTERING=$(PITCH_SCATTERING) -DENERGY_SCATTERING=$(ENERGY_SCATTERING)
NVCCFLAGS += $(INCLUDEFLAGS) -DDEBUGLEVEL=$(DEBUG) -DPITCH_SCATTERING=$(PITCH_SCATTERING) -DENERGY_SCATTERING=$(ENERGY_SCATTERING)
