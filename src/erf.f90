...
FUNCTION erf_external_fn(x) RESULT(fn_val)
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
IMPLICIT NONE
INTEGER, PARAMETER :: dp = SELECTED_REAL_KIND(13, 300)      ! `Double precision'
...
fn_val = SIGN(one, x)
RETURN
END FUNCTION erf_external_fn

end module erf_external
